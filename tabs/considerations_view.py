...
considerations = dbc.Row([
    dbc.Card([
        dbc.CardBody([
            ...
            html.P(["1. This algorithm works for 1 name at a time. When cleaning large sets of data this can be a real constraint. However, once all the data is clean this presents a very small consideration in multithreaded pipeline."]),
